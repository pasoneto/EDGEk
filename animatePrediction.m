...
files = dir("/Users/pdealcan/Documents/github/data/CoE/accel/amass/DanceDBPoses/predictedWatch/");
% 
% dirTruth = "/Users/pdealcan/Documents/github/EDGEk/data/accel/test/motions_sliced_csv/"
% files = dir("/Users/pdealcan/Documents/github/EDGEk/data/accel/test/predictedWatch/");

randIndex = randi([3 length(files)]);
% "sliced_6_Vasso_Bored_01_poses.csv"
% names = ["sliced_1_Stefanos_1os_antrikos_karsilamas_C3D_poses.csv", "sliced_24_AnnaCortesi_BellyDance2_C3D_poses.csv", "sliced_1_Vasso_Happy_01_poses.csv", "sliced_7_Nikos_Zeibekiko_C3D_poses.csv", "sliced_13_Maritsa_Relaxed_C3D_poses.csv", "sliced_3_Maritsa_Sad_C3D_poses.csv", "sliced_7_Nikos_Zeibekiko_C3D_poses.csv"];
for k=3:length(names)
%     nameChosen = files(randIndex).name
    nameChosen = names(k)
    true = strcat(dirTruth, nameChosen);
    pred = strcat(files(randIndex).folder, "/", nameChosen);
    ...
    % par.markercolors='bbrbbrbbbbbbbbbbbbbbbbbb'
    ...
    % par2.markercolors='rrbrrbrrrrrrrrrrrrrrrrrr'
