...
#    faces = smplx_model.faces
    ...
    mesha = trimesh.Trimesh(vertices) #    l, w = vertices.shape
...
joints = bodyModel.joints.detach().numpy()[0]
vertices = bodyModel.vertices.detach().numpy()[0] #Vertices are probably given as positions. Need quaternions
